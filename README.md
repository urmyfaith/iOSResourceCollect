...
| 0001  | http://ios.jobbole.com/81527/ |
...
| 序号 |知识点| 面试 |
| ------------- | ------------ |---|
|0001| 单链表  | http://www.cnblogs.com/huangxincheng/p/4051854.html |
|0002|HTTP状态码|几个常见的 HTTP状态码|https://www.v2ex.com/t/161929|
~
...
| 0004 |[(唐巧)使用Objective-C的文档生成工具:appledoc](http://www.devtang.com/blog/2012/02/01/use-appledoc-to-generate-xcode-doc/)|
| 0005|[(唐巧)使用Github来管理xcode4中的代码片段](http://www.devtang.com/blog/2012/02/04/use-git-to-manage-code-snippets/)|
|0006|[(nearthespeedoflight)xcode_4_code_snippets](http://nearthespeedoflight.com/article/xcode_4_code_snippets)|
|0007|[(唐巧)斯坦福大学iOS开发公开课总结(mvc,kvo,UIView的层次,nib文件)](http://www.devtang.com/blog/2012/02/05/mvc-in-ios-develop/)|
...
| 序号 | 可供模仿 |
| ------------- | ------------ |
| 0001  | 下载android和iphone版本的http://www.palmtrends.com/ |
|   |  |
|   |  |


**以下部分摘录自*Aufree的github*,有修改.

万紫千红一片绿(10000 * 5+1000 * 100+50 * x = 15 w + )
...
CS 193P iPhone Application Development |[CS 193P iPhone Application Development](http://web.stanford.edu/class/cs193p/cgi-bin/drupal/downloads-2013-fall)
...
[斯坦福大学公开课：iPhone开发教程2010年冬](http://v.163.com/special/opencourse/iphonekaifa.html)|斯坦福大学公开课：iPhone开发教程2010年冬|
...
[字节技术(******)](http://www.4byte.cn/)| 虽然网站的翻译不怎么样,但是很多英文的问题,确实是一直常见遇到的问题.
...
51. [酷炫的标签栏动画](https://github.com/Ramotion/animated-tab-bar)|酷炫的标签栏动画
## 邮件订阅
